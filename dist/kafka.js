...
exports.withKafkaConsumer = exports.withKafkaProducer = exports.createKafkaConf = void 0;
`use strict`;
...
function withKafkaProducer(kafkaClient, prefix) {
...
exports.withKafkaProducer = withKafkaProducer;
function withKafkaConsumer(kafkaClient, prefix, groupId, writer) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.withKafkaConsumer = withKafkaConsumer;
